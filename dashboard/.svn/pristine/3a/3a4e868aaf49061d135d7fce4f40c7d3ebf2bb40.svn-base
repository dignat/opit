...
class MonthlyStatsJob {
    static triggers = {
      cron cronExpression: '0 0 1,13 * * ?' // every 12hrs at 1am and 1pm
    }
        ...
        // execute job
			...
			dataCenter.each {
				...
				def vm = new MonthlyStats(virtualMachine:vmname,description:os, cpuCount:cpuCount, memory:memory, memoryOverhead:memoryOverhead, state:state, vmWareToolStatus:vmWareToolStatus, ipAddress:ip, 
